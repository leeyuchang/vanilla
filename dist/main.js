...
/* harmony import */ var _views_LandingView_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
/* harmony import */ var _model_ListModel_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
/* harmony import */ var _model_MovieListModel_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  init() {
    ...
    _views_LandingView_js__WEBPACK_IMPORTED_MODULE_3__["default"]
  ...
  fetchData() {
   _model_ListModel_js__WEBPACK_IMPORTED_MODULE_4__["default"]
      .getData("/data/data.json")
      .then(data => _views_BlogListView_js__WEBPACK_IMPORTED_MODULE_1__["default"].render(data))
  },

  fetchMovieData() {
    _model_MovieListModel_js__WEBPACK_IMPORTED_MODULE_5__["default"]
      .getData()
      .then(data => {
        console.log(TAG, data);
        _views_LandingView_js__WEBPACK_IMPORTED_MODULE_3__["default"].render(data)
      })
  },
  ...
  onShowMoiveInfo(id) {
    _model_MovieListModel_js__WEBPACK_IMPORTED_MODULE_5__["default"].getMovieInfo(id).then(data => console.log('onShowMoiveInfo', data))
  }
...
const LandingView = Object.create(_View_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
LandingView.getLandingHtml = function (data) {
  return data
    .map(item => `<li class="card-item" data-id="${item.id}">
                    <figure class="card-image" style="background-image: url(${_Config_js__WEBPACK_IMPORTED_MODULE_1__["IMAGE_BASE_URL"]}w500/${item.poster_path})">
                    </figure>
                    <div class="card-desc">
                      ${item.overview}
                    </div>
...
/* harmony default export */ __webpack_exports__["default"] = (LandingView);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "USER_SERVER", function() { return USER_SERVER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "API_URL", function() { return API_URL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "API_KEY", function() { return API_KEY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IMAGE_BASE_URL", function() { return IMAGE_BASE_URL; });
const USER_SERVER = '/api/users'
const API_URL = 'https://api.themoviedb.org/3/'
const API_KEY = '423abe988671a51e10476eb53f673b80'
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  repo : [],
  async getData() {
    const endpoint = `${_Config_js__WEBPACK_IMPORTED_MODULE_1__["API_URL"]}movie/popular?api_key=${_Config_js__WEBPACK_IMPORTED_MODULE_1__["API_KEY"]}&language=en-US&page=${this.page++}`;
    const { data } = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(endpoint);
    return this.repo = this.repo.concat(data.results);
  },
  async getMovieInfo(movieId) {
    const endpoint = `${_Config_js__WEBPACK_IMPORTED_MODULE_1__["API_URL"]}movie/${movieId}/credits?api_key=${_Config_js__WEBPACK_IMPORTED_MODULE_1__["API_KEY"]}`
    const { data } = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(endpoint)
